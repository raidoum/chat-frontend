...
export declare const FONT_DEFAULT_BY_STYLE: {
    VectorEsriTopographic: string;
    VectorEsriStreets: string;
    VectorEsriLightGrayCanvas: string;
    VectorEsriDarkGrayCanvas: string;
    VectorEsriNavigation: string;
    VectorHereBerlin: string;
};
